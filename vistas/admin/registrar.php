                ...
                <div class="row">
                  ...
                  <div class="col-8">
                    ...
                    <form action="../../controlador/ControladorParqueadero.php" method="POST">
                      <div class="row fila">                  
                        <div class="col-6">
                          <input type="text" name="fecha" placeholder="Fecha" class="columna">
                        </div>
                        <div class="col-6" >
                      ...
                      <div class="row fila"> 
                        <div class="col-6">
                          <input type="text" name="precioD" placeholder="Precio diurno" class="columna">
                        </div>
                        <div class="col-6">
                          <input type="text" name="precioN" placeholder="Precio nocturno" class="columna">
                        </div>
                      </div>
